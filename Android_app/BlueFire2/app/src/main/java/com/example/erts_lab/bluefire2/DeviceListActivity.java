...
* Filename: <DeviceListActivity>
* Functions: <onCreate(Bundle savedInstanceState)>
* Object: <EXTRA_DEVICE_ADDRESS,mBtAdapter,mNewDevicesArrayAdapter>
*
*/
 ...
 * When a device is chosen by the user, the MAC address of the device is sent back to the parent
...
public class DeviceListActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> pairedDevicesArrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1);
